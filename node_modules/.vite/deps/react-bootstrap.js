...
import {
  ...
  useWaitForDOMRef,
  useWindow
} from "./chunk-MZWDGKPS.js";
import "./chunk-3LV4L4CH.js";
import {
  NavbarContext_default,
  SelectableContext_default,
  makeEventKey
} from "./chunk-E7DEVIL4.js";
import {
  dataAttr,
  qsa
...
import {
  ...
  AlertLink_default,
  Alert_default
} from "./chunk-KORGZ6WQ.js";
import {
  Anchor_default,
  useEventListener
} from "./chunk-2G3DMBU2.js";
import {
  useCallbackRef
...
function DropdownToggle({
  ...
  return (0, import_jsx_runtime16.jsx)(import_jsx_runtime15.Fragment, {
    children: children(props, meta)
  });
}
...
var DropdownItem = React18.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime17.jsx)(Component2, Object.assign({}, props, {
    ref
  }, dropdownItemProps));
});
...
function Dropdown({
  ...
  return (0, import_jsx_runtime18.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime18.jsx)(DropdownContext_default.Provider, {
      value: context4,
      children
    })
  });
...
var FigureImage = React31.forwardRef(({
  ...
  fluid = true,
  ...props
}, ref) => (0, import_jsx_runtime29.jsx)(Image_default, {
  ref,
  ...props,
  fluid,
...
var InputGroupCheckbox = (props) => (0, import_jsx_runtime33.jsx)(InputGroupText_default, {
  children: (0, import_jsx_runtime33.jsx)(FormCheckInput_default, {
    type: "checkbox",
    ...props
  })
});
var InputGroupRadio = (props) => (0, import_jsx_runtime33.jsx)(InputGroupText_default, {
  children: (0, import_jsx_runtime33.jsx)(FormCheckInput_default, {
    type: "radio",
    ...props
  })
...
var InputGroup = React35.forwardRef(({
  ...
  return (0, import_jsx_runtime33.jsx)(InputGroupContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime33.jsx)(Component2, {
      ref,
      ...props,
...
var NavDropdown = React38.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime37.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames28.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime36.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime36.jsx)(Dropdown_default2.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React39.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
...
var PopoverHeader = React40.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React41.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime47.jsxs)(import_jsx_runtime46.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react24.cloneElement)(children, triggerProps), (0, import_jsx_runtime45.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React47.forwardRef(({
  ...
  return (0, import_jsx_runtime48.jsx)("li", {
    ...
    children: (0, import_jsx_runtime49.jsxs)(Component2, {
      className: (0, import_classnames34.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
...
var Pagination = React48.forwardRef(({
  ...
  return (0, import_jsx_runtime50.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames35.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames36.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var SplitButton = React54.forwardRef(({
  ...
  children: [(0, import_jsx_runtime56.jsx)(Button_default2, {
    size,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime56.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size,
    variant,
...
var TabContent = React59.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Table = React61.forwardRef(({
  ...
  const classes = (0, import_classnames43.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size && `${decoratedBsPrefix}-${size}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
...
var ToastFade = React63.forwardRef((props, ref) => (0, import_jsx_runtime67.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToggleButton = React69.forwardRef(({
  ...
  return (0, import_jsx_runtime75.jsxs)(import_jsx_runtime74.Fragment, {
    children: [(0, import_jsx_runtime73.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime73.jsx)(Button_default2, {
      ...props,
      ref,
